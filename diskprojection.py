...
class disk_observation(imagecube):
    ...
    def bin_in_radius(self, r, x, rbins=None, rvals=None, average='mean',
        ...
        z_avg = binned_statistic(r, x, rbins, statistic=avg_func)[0]

        if uncertainty.lower() == 'std':
            z_err = binned_statistic(r, x, rbins, statistic=np.nanstd)[0]
            ...
            z_err_a = binned_statistic(r, x, rbins, statistic=err_a)[0]
            z_err_b = binned_statistic(r, x, rbins, statistic=err_b)[0]
            z_err_c = binned_statistic(r, x, rbins, statistic=err_c)[0]
